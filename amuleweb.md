...
购买域名和证书，架设 HTTPS 网站的具体步骤就不介绍了，网上很多教程。
...
类似地，用 nginx 做反代的配置：
    ...
    location /amuleweb/ {
        proxy_pass http://127.0.0.1:4682;
    }
...
一般的防火墙软件都能做到这一点。这里给出 iptables 的设置。

首先安装 iptables-persistent。其作用是在系统重启后自动加载 iptables 规则。
